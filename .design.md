⬇️ [Dict](Dict/.design.md) · [Core](Core/.design.md) · [Utils](Utils/.design.md) · [Win](Win/.design.md) · [Mac](Mac/.design.md) · [Linux](Linux/.design.md)
...
| [`Utils`](Utils/.design.md) | 1 ✅ | Reusable concurrency primitives (`DynamicResult` etc.), shared by Core and platform UI crates |
