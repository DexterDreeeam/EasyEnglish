⬇️ [Dict](Dict/.design.md) · [Core](Core/.design.md) · [Utils](Utils/.design.md) · [App](App/.design.md)
...
| [`Utils`](Utils/.design.md) | 1 ✅ | Reusable concurrency primitives (`DynamicResult` etc.), shared by Core and the App platform crates |
| [`App`](App/.design.md) | 2 🔨 | Platform integrations grouped under one umbrella: [`Win`](App/Win/.design.md), [`Mac`](App/Mac/.design.md), [`Linux`](App/Linux/.design.md) |
